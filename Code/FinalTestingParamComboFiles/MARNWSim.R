...
epsilon <- 0.000001
nitermax <- 30000
alphaV <- sim$alpha #c(0.00001, 0.00005,0.0001, 0.0005,0.001,0.005,0.01)
test = FALSE
randomize = TRUE
missingV <- list(c(15,0,0,0,0,0),
                 ...
                 c(15,15,0,0,0,0),
                 c(25,0,0,0,0,0))
missing <- missingV[[as.numeric(1)]]#missingV[[as.numeric(args[1])]]
alphaLin <- 1#0.001
penaltyV <- c("LASSO")
seed <- sample(1:100000, 1)
lambda_linV  <- sim$lambda_lin #c(0.00001 ,0.0001, 0.001, 0.01)#,0.0001, 0.001, 0.01)
lambda_binV  <- sim$lambda_bin#c(0.00001 ,0.0001, 0.001, 0.01)#c(0.00001,0.0001, 0.001,0.01)
            ...
            for(penalty in penaltyV){
              ...
              if(reg == TRUE){
                print(paste0("in the ", dir,
                             ...
                             " lambda bin ", lambda_bin, " lambda lin ", lambda_lin,
...
saveRDS(opf_Regcov, paste0("/home/phatakg/novus/Output_rds/MARSimulation_",args[1],"_",args[2],".rds"))  
