...
dat <- read_excel(paste0(path_home(),
                         "/Box/Preliminary Results Coronavirus Sewer Surveillance/ddPCR results/Covid/R output data/11.7.23 (1)/Combined_all_data_2023-11-08.xlsx"), 
                  sheet = "COVID",
                  guess_max = 10000)
